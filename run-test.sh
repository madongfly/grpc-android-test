...
# Usage example: ./run-test.sh <avd-name> -e server_host <hostname or ip address> -e server_port 8030 -e server_host_override foo.test.google.fr -e use_tls true -e use_test_ca true -e test_case empty_unary
cd "$(dirname "$0")"
